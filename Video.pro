...
DISTFILES += \
    imagenes/Disco.mp4 \
    imagenes/El poder de tu visión.mp4 \
    imagenes/El poder de tu visión.mp4 \
    imagenes/Encuentra tu visión con Arnold Schwarzenegger.mp4 \
    imagenes/Esclava (Remix).mp3 \
    imagenes/Esclava (Remix).mp3 \
    imagenes/Las reglas del exito.mp4 \
    imagenes/Las reglas del exito.mp4 \
    imagenes/Las reglas del exito.mp4 \
    imagenes/Música De Fondo Inspiradora y Dramática Para Videos.mp3 \
    imagenes/Música De Fondo Inspiradora y Dramática Para Videos.mp3 \
    imagenes/Sebastián Yatra - No Hay Nadie Más (Official Video).mp3 \
